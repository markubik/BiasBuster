...
def test_model():
    head = '''Here's who loves Biden's vaccine mandate: The companies that have to enforce it'''
    body = '''New York (CNN Business)President Joe Biden gave a gift to every major company in America by forcing them to mandate vaccines or stringently test their employees for Covid. Their reaction to the new rule: glee.
